"""
Boodschappen Agent v5b — T5_test.py

Gelijk aan T3_test.py, met:
  - De exact gematchte AH/Jumbo-producten getoond onder de prijsvergelijking
    in het advies, zodat je ziet welk product elke prijs vertegenwoordigt.
  - Debug-logging van de ruwe API-resultaten in _ah_search/_jumbo_search verwijderd.

Onderliggende verbeteringen (uit T3):
  A. Betere _beste_match:
     - Woordgrens-matching via _woord_match (bijv. "pinda" ≠ "pindakaas")
     - Eenvoudige Nederlandse meervoud/verkleinwoord-tolerantie (balletje ↔ balletjes)
     - Ruispenalty: titels met veel niet-matchende woorden scoren lager
  B. Betere extractie-prompt:
     - Beschrijvende woorden (vegetarisch, biologisch, mager, ...) expliciet behouden
     - Alleen verpakkings-/containerwoorden worden verwijderd
     - Extra voorbeeld met bijvoeglijk naamwoord om het model te sturen
...
if __name__ == "__main__":
    ...
    print("=== Supermarkt Vergelijker v5b (T5) ===")
