...
CHROMA_PAD = os.path.join(os.path.dirname(os.path.abspath(__file__)), "jchroma_db")
...
def zoek_producten(query: str, winkel: str, n: int = 8) -> list[dict]:
    ...
    for doc, meta, dist in zip(res["documents"][0], res["metadatas"][0], res["distances"][0]):
        resultaten.append({
            ...
            "aantal_in_verpakking": meta.get("aantal_in_verpakking", 1),
            "eenheid": meta.get("eenheid", "stuk")
        })
    return resultaten
